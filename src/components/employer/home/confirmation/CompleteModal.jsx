            ...
            <div className="relative md:w-2/6 my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto">
                 <div className='py-5'>
                  <h1 className='md:text-2xl text-center font-serif font-semibold'>Are sure You want to compelte this post now </h1>
                 </div>
                 <div className='py-5'>
                  <h1 className='ms:text-lg text-center font- font-semibold'>Click confirm to compete</h1>
                 </div>
