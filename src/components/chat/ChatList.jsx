...
export default function ChatList({ data, empid,getUserData }) {
  ...
  return (
    <div className="flex items-center shadow-lg border p-1  bg-bluegray  border-gray-300 mx-1 my-1 rounded-xl ">
      ...
      <div className="md:text-lg  font-semibold">
        <h1 className="ms-3  ">{userData?.name?userData.name:userData?.cmpName}</h1>
